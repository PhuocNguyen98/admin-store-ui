...
import { getSupplierApi, quickUpdateSupplierApi } from '~/api/supplierApi';
...
function Supplier() {
  ...
  const getDataApi = async () => {
    try {
      const res = await getSupplierApi(searchValue, sort, order, pageCurrent, rowsPerPage);
